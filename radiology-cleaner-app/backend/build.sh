...
# --- Step 2: Install All Python Dependencies at Once ---
# This is now possible because hnswlib provides pre-compiled wheels,
# avoiding the nmslib build failures.
...
python -c "import hnswlib; print('    ✅ HNSWLib imported successfully')" # Verify the new library
