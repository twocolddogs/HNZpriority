...
def parse_batch_v2():
    ...
    try:
        ...
        logger.info(f"Secondary pipeline: {enable_secondary and secondary_integration and secondary_integration.is_enabled()}")
            ...
            try:
                ...
                try:
                    ...
                    if secondary_report and secondary_report.get('improved_results', 0) > 0:
                        logger.info(f"Secondary processing improved {secondary_report.get('improved_results', 0)} results")
                finally:
                    loop.close()
        ...
        # Build response
        response = {
            "message": "Enhanced batch processing complete" + (" with secondary pipeline" if secondary_report else ""),
            "processing_stats": {
